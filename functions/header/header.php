				...
				<ul id="cfp-header-options">
					<li id="cfp-header-featured">
						<label for="cfcp-header-type-featured">
							...
							<img src="<?php get_template_directory_uri(); ?>/functions/header/img/header-option-posts.png" alt="<?php _e('Featured Posts', 'favepersonal'); ?>" height="56" width="250" />
						</label>
					...
					<li id="cfp-header-image">
						<label for="cfcp-header-type-image">
							...
							<img src="<?php get_template_directory_uri(); ?>/functions/header/img/header-option-image.png" alt="<?php _e('Header Image', 'favepersonal'); ?>" height="56" width="250" />
						</label>
