<div class="cfp-popover-content" id="cfp-link-edit">
	...
	<div class="cf-elm-block">
		...
		<input type="text" name="title" id="cfp-link-title" value="" />
	</div>
	
	<div class="cf-elm-block">
		<label for="cfp-link-url"><?php _e('Link', 'carrington-personal'); ?></label>
		<input type="text" name="url" id="cfp-link-url" value="" />
	</div>
	
	<div class="cf-elm-block" id="cfp-link-icon-preview" style="display: none;">
		...
		<div id="cfp-link-icon-message"></div>
	</div>
