...
<p id="you-must-be-logged-in-to-comment"><?php printf(__('You must be <a href="%s">logged in</a> to post a comment.', 'favepersonal'), esc_url(site_url('wp-login.php?redirect_to='.urlencode(get_permalink())))); ?></p>
...
<?php } ?>
<?php if (is_user_logged_in()) { ?>
		<div class="social-input-row"><?php printf(__('Logged in as <a href="%s">%s</a>. ', 'favepersonal'), admin_url('profile.php'), $user_identity); wp_loginout(); ?>.</div>
<?php } ?>
